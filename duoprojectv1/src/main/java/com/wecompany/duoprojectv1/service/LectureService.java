...
public class LectureService {
    ...
    private final LectureMapper lectureMapper;
     private final InstructorMapper instructorMapper; // ✅ 추가
    ...
    private LectureResponseDto toDto(Lecture lecture) {
        ...
        dto.setInstructorName(lecture.getInsName());
        dto.setInstructorName(instructorMapper.findById(lecture.getInsId()).map(Instructor::getInsName).orElse("미정"));
